...
mod tests {
    ...
    fn test_commutativity_rotate_get_child() {
        ...
        assert_eq!(pubkey_view_party1.get_element(), pubkey_view_party2.get_element());
        ...
        let (sign_helper_party1, sign_party1_message2) = rc_party_one_master_key.sign_second_message(&eph_keygen_party1, &eph_keygen_party2.first_message, &message);
        let (sign_helper_party2, sign_party2_message2) = rc_party_two_master_key.sign_second_message(&eph_keygen_party2, &eph_keygen_party1.first_message, &message);
        let _signature_view_party1 = rc_party_one_master_key.signature(&sign_party1_message2, &sign_party2_message2, &sign_helper_party1).expect("bad signing");
        let _signature_view_party2 = rc_party_two_master_key.signature(&sign_party2_message2, &sign_party1_message2, &sign_helper_party2).expect("bad signing");
        ...
        let eph_keygen_party1 = MasterKey1::sign_first_message();
        let eph_keygen_party2 = MasterKey2::sign_first_message();
        let (sign_helper_party1, sign_party1_message2) = cr_party_one_master_key.sign_second_message(&eph_keygen_party1, &eph_keygen_party2.first_message, &message);
        let (sign_helper_party2, sign_party2_message2) = cr_party_two_master_key.sign_second_message(&eph_keygen_party2, &eph_keygen_party1.first_message, &message);
        let _signature_view_party1 = cr_party_one_master_key.signature(&sign_party1_message2, &sign_party2_message2, &sign_helper_party1).expect("bad signing");
        let _signature_view_party2 = cr_party_two_master_key.signature(&sign_party2_message2, &sign_party1_message2, &sign_helper_party2).expect("bad signing");

        // test rotate -> child pub key == child -> rotate pub key
        assert_eq!(cr_party_one_master_key.pubkey.get_element(), rc_party_one_master_key.pubkey.get_element());
    ...
    fn test_get_child() {
        ...
        let eph_keygen_party1 = MasterKey1::sign_first_message();
        let eph_keygen_party2 = MasterKey2::sign_first_message();
        let (sign_helper_party1, sign_party1_message2) = party_one_master_key.sign_second_message(&eph_keygen_party1, &eph_keygen_party2.first_message, &message);
        let (sign_helper_party2, sign_party2_message2) = party_two_master_key.sign_second_message(&eph_keygen_party2, &eph_keygen_party1.first_message, &message);
        let _signature_view_party1 = party_one_master_key.signature(&sign_party1_message2, &sign_party2_message2, &sign_helper_party1).expect("bad signing");
        let _signature_view_party2 = party_two_master_key.signature(&sign_party2_message2, &sign_party1_message2, &sign_helper_party2).expect("bad signing");
        ...
        let eph_keygen_party1 = MasterKey1::sign_first_message();
        let eph_keygen_party2 = MasterKey2::sign_first_message();
        let (sign_helper_party1, sign_party1_message2) = new_party_one_master_key.sign_second_message(&eph_keygen_party1, &eph_keygen_party2.first_message, &message);
        let (sign_helper_party2, sign_party2_message2) = new_party_two_master_key.sign_second_message(&eph_keygen_party2, &eph_keygen_party1.first_message, &message);
        let _signature_view_party1 = new_party_one_master_key.signature(&sign_party1_message2, &sign_party2_message2, &sign_helper_party1).expect("bad signing");
        let _signature_view_party2 = new_party_two_master_key.signature(&sign_party2_message2, &sign_party1_message2, &sign_helper_party2).expect("bad signing");
    ...
    fn test_flip_masters() {
        ...
        let eph_keygen_party1 = MasterKey1::sign_first_message();
        let eph_keygen_party2 = MasterKey2::sign_first_message();
        let (sign_helper_party1, sign_party1_message2) = party_one_master_key_rotated.sign_second_message(&eph_keygen_party1, &eph_keygen_party2.first_message, &message);
        let (sign_helper_party2, sign_party2_message2) = party_two_master_key_rotated.sign_second_message(&eph_keygen_party2, &eph_keygen_party1.first_message, &message);
        let _signature_view_party1 = party_one_master_key_rotated.signature(&sign_party1_message2, &sign_party2_message2, &sign_helper_party1).expect("bad signing");
        let _signature_view_party2 = party_two_master_key_rotated.signature(&sign_party2_message2, &sign_party1_message2, &sign_helper_party2).expect("bad signing");
